                ...
                <div className="absolute left-0 sm:right-0 top-full mt-2 w-full sm:w-72 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-2xl p-3.5 sm:p-4 z-50 animate-in fade-in slide-in-from-top-2 duration-150">
                  ...
                  <div className="grid grid-cols-7 gap-1 text-center mb-2">
                    {['D', 'L', 'M', 'M', 'J', 'V', 'S'].map((d, idx) => (
                      <span
                        key={idx}
                        className={`text-[9px] font-black uppercase tracking-wider ${idx === 6
                    ...
                    {getDaysForCalendar(currentCalendarMonth).map((day, idx) => {
                      ...
                      return (
                        <button
                          ...
                          className={`w-8 h-8 text-[11px] font-black rounded-lg flex items-center justify-center transition-all cursor-pointer relative ${isSelected
          ...
          {saturdaysList.map((sat) => {
            ...
            return (
              <button
                ...
                className={`flex-1 min-w-[76px] md:min-w-0 py-2.5 px-1 rounded-xl transition-all duration-200 flex flex-col items-center justify-center cursor-pointer ${isActive
              ...
              >
                ...
                {sat.isTodayWeek && (
                  <span className={`text-[6px] font-black px-1.5 py-0.5 rounded-md mt-1 ${isActive ? 'bg-white/20 text-white' : 'bg-indigo-50 dark:bg-indigo-950/60 text-indigo-600 dark:text-indigo-300'
                    }`}>Actual</span>
                )}
              </button>
            );
                          ...
                          return (
                            ...
                            >
                              ...
                              <div
                                ...
                                className={`w-full h-56 rounded-2xl ${theme.imageBorder} overflow-hidden bg-gradient-to-br ${isFileImage ? 'from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900' : theme.pdfGradient
                              ...
                              >
                                ...
                                <span className={`absolute top-3 left-3 backdrop-blur-md text-white text-[7px] font-black uppercase px-2.5 py-1 rounded-full shadow-xs tracking-wider z-20 ${isFileImage
                              ...
                              <div className="flex flex-col gap-3 min-w-0">
                                <div className="min-w-0 px-0.5">
                                  ...
                                  <p className={`text-[9px] font-black uppercase tracking-wider mt-0.5 ${isFileImage ? 'text-blue-600 dark:text-blue-400' : 'text-red-500 dark:text-red-400'
                                    }`}>
